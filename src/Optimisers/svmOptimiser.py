...
def optimise_support_vector_machine(training_dataset, validation_dataset, selected_metric_type, direction):
    ...
    for target_column in META_LEANER_TARGET_COLUMNS:
        ...
        print(f"Tuned params for svm for {target_column} resulting in {validation_loses} {selected_metric_type}")
...
def train_support_vector_machine_warp(params):
    ...
    stats, _ = train_meta_support_vector_machines(params, training_set, validation_set, seed, kFold=5, metric_type=metric_type)
